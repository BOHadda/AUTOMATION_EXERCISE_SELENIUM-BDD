...
public class LoginPage {
	...
	final static String EMAIL_ADDRESS = "//input[contains(@data-qa,'login-email')]";
	final static String PASSWORD_LOGIN = "//input[contains(@data-qa,'login-password')]";
	final static String LOGIN_BUTTON = "//button[contains(@data-qa,'login-button')]";
	...
	@FindBy(how = How.XPATH, using = PASSWORD_LOGIN)
